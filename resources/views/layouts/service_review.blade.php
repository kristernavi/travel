            ...
            <table class="cart-table table">
                <tr>
                    <td class="item-name-col">
                        <figure>
                            <a href="#"><img src="{{  asset('storage/'.ltrim($detail->destination->image, 'public')) }}" alt="{{ $package->name }}" height="20%" width="40%"></a>
                        </figure>
                        <header class="item-name"><a href="#">{{ $package->name }}</a></header>
                        <ul>
